...
Route::prefix('class')->group(function () {
    Route::get('/index/{courseId?}/{majorId?}/{subjectId?}', [ClassController::class, 'index'])->name('class.index');
    ...
    Route::get('/restore/{id}', [ClassController::class, 'restore'])->name('class.restore')->where(['id' => '[0-9]+']);
    Route::post('/forceDelete/{id}', [ClassController::class, 'forceDelete'])->name('class.forceDelete')->where(['id' => '[0-9]+']);
});
