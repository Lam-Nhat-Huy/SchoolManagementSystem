...
class ClassrooomController extends Controller
{
    ...
    public function store(StoreClassroomRequest $request)
    {
        ...
        if ($data) {
            ...
            toastr()->success('Thêm phòng học thành công');
    ...
    public function update(UpdateClassroomRequest $request)
    {
        ...
        if ($data) {
            ...
            toastr()->success('Cập nhật phòng học thành công');
    ...
    public function trash($id)
    {
        ...
        toastr()->success('Đã Ẩn Phòng Học');
    ...
    public function restore($id)
    {
        ...
        toastr()->success('Đã Khôi Phục Phòng Học');
    ...
    public function delete($id)
    {
        ...
        toastr()->success('Đã Xóa Phòng Học');
